...
// Manages the Win32 window backing a Flutter view.
class Win32Window {
 public:
  struct Point {
    unsigned int x;
...
bool Win32Window::Create(const std::wstring& title,
  ...
  WNDCLASS window_class_ex = {};
  window_class_ex.hCursor = LoadCursor(nullptr, IDC_ARROW);
  window_class_ex.lpfnWndProc = WndProc;
  window_class_ex.lpszClassName = window_class;
  window_class_ex.style = CS_HREDRAW | CS_VREDRAW;
  window_class_ex.cbClsExtra = 0;
  window_class_ex.cbWndExtra = 0;
  window_class_ex.hInstance = GetModuleHandle(nullptr);
  window_class_ex.hIcon =
      LoadIcon(window_class_ex.hInstance, MAKEINTRESOURCE(IDI_APP_ICON));
  window_class_ex.hbrBackground = 0;
  window_class_ex.lpszMenuName = nullptr;

  RegisterClass(&window_class_ex);

  auto monitor = MonitorFromWindow(window_handle_, MONITOR_DEFAULTTONEAREST);
