...
def test_vless_uri_parsing():
    ...
    try:
        ...
        main_module.generate_config(test_uri)
...
def test_fallback_system():
    ...
    try:
        # Check Windows compatible version first
        main_file = 'main_windows_compatible.py' if os.path.exists('main_windows_compatible.py') else 'main.py'
